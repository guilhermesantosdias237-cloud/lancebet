// Regras & LGPD (rota /regras). Página estática.
// Porte fiel de design/lancebet-react/src/pages/Rules.jsx.
import type { CSSProperties } from 'react'
import Footer from '../../components/lancebet/Footer'

const section: CSSProperties = { marginBottom: 34 }
const h2: CSSProperties = { fontFamily: "'Alfa Slab One', serif", fontSize: 24, margin: '0 0 12px', borderBottom: '2px solid #000', paddingBottom: 8 }
const p: CSSProperties = { fontSize: 15, lineHeight: 1.65, color: '#333', margin: 0 }
